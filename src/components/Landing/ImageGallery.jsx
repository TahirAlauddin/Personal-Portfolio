  ...
  const projects = [
    {
      ...
      "descripttion": "AllBooksQuotes is a Web application made with Django which works with Amazon Affiliate Program and Google Adsense. It is a community for enthusiast Book Readers to read over 50,000 quotes from over 11,000 books from different categories.",
      "images": [
    ...
    },
    {
      ...
      "description": "Aspect Gaming Tweaks is a software I made for a Saudi Community, made of gaming enthusiast. The job of the software is to make the windows delete any restricting features that come in the way of gaming.The software run a bunch of bat files and sets reg for enhancing the user experience on their gaming PCs. The idea is to make the PC efficient for specific users. It also implements Licensing through AWS.",
      "images": [
    ...
    },
    {
      ...
      "description": "Recipito is a robust recipe website designed to cater to food enthusiasts just like marmiton.org. Developed using Python, Django, HTML, CSS and JavaScript, this platform empowers users to create and share their culinary masterpieces, complete with detailed ingredients and utensil models.",
      "images": [
    ...
    },
    {
      ...
      "tags": [
        "Python", "PyQt", "ChatGPT", "API", "Desktop Application", "Git"
      ],
      "description": "An AI powered Medical Software for managing patients, appointments and doctors along with the option to diagnose the symptoms of the patient using OpenAI model GPT3. It's developed with Python and PyQt5.",
      "images": [
    ...
    },
    {
      ...
      "description": "Starc Assistant is a robust desktop server application designed to augment the support mechanism for Gentilini Power-Train's employees.",
      "images": [
    ...
    },
    {
      ...
      "tags": [
        "Web Development", "Django", "Git", "Desktop Application", "Web Application", "API", "Microsoft Azure", "Python"
      ],
      "description": " Loote Mass Email Sender is a desktop application that sends bulk emails to clients using Microsoft Azure Graph API. A user can also choose from templates saved locally. It gets the analytics like click, open and bounce rate from the API hosted on cloud made with Django Server.",
      "images": [
        "/assets/img/Portfolio/Starc Assistant/login.webp",
        "/assets/img/Portfolio/Starc Assistant/home.webp",
        "/assets/img/Portfolio/Starc Assistant/chatbot-interface.webp",
    ...
    },
    {
      ...
      "description": "Moop Bot is an AI powered assistant designed to respond to queries and assist the user. It is integrated with ElevenLabs TTS API and OpenAI GPT-3.5-turbo.",
      "images": [
