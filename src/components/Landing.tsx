    ...
    <div className='landing-parent'>
      <div className="landing-container pb-0 ml-0">
        <div className="content">
          ...
          <h1 className="heading text-left">Hey There <span role="img" aria-label="wave">👋</span></h1>
          ...
          <a href="https://wa.me/923233428060"><button className="contact-btn">Get in Touch</button></a>
          <div className="social-icons">
            <a href=""><img src={facebookIcon} alt="Facebook" className="icon" /></a>
            <a href="https://www.linkedin.com/in/tahiralauddin"><img src={linkedinIcon} alt="LinkedIn" className="icon" /></a>
